...
public class Sprite {
	 ...
	 * |--------------------------------------------------------------------------
	 */
	public static Sprite red = new Sprite(DEFAULT_SIZE, 0, 14, SpriteSheet.tiles, 16, 16);
	public static Sprite dell = new Sprite(DEFAULT_SIZE, 0, 12, SpriteSheet.tiles, 16, 16);
